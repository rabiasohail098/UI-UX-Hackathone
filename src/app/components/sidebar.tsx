...
const Sidebar = () => {
  ...
  return (
      <div>
            <aside className="w-[200px] px-4 md:w-1/4 flex flex-col gap-8">
        {/* Filter Section */}
        <div className="space-y-4">
          <Filterproduct />
          <div className="border w-[250px] border-gray-400 rounded-lg p-4">
        ...
        {/* Promotional Section */}
        <div className="bg-cover w-[250px] bg-center rounded-lg p-4 h-72" style={{ backgroundImage: "url('/images/shop.png')" }}>
